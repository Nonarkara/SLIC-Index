...
def build_city_universe() -> list[dict[str, str]]:
    europe_core = "Western, Northern, and Southern Europe"
    return [
        row(
            "th-bangkok",
            "Bangkok",
        ...
        row(
            "my-kota-kinabalu",
            "Kota Kinabalu",
            "Kota Kinabalu Urban Area",
            "Malaysia",
            "Southeast Asia",
            "secondary",
            "provisional",
            "User anchor — nature tourism, safety, and affordable livability on Borneo's coast.",
        ),
        row(
            "my-melaka",
            "Melaka",
            ...
            "secondary",
            "provisional",
            "User anchor — deep cultural heritage, food scene, and underrated livability.",
        ),
        row(
            "th-hat-yai",
            "Hat Yai",
        ...
        row(
            ...
            "primary",
            "provisional",
            "Western China lifestyle benchmark included for food culture, livability, and economic dynamism beyond coastal mega-cities.",
        ),
        row(
            "cn-chongqing",
            "Chongqing",
            ...
            "primary",
            "provisional",
            "Interior mega-city benchmark included for urban energy, affordability, and infrastructure ambition.",
        ),
        row(
            "cn-hangzhou",
            "Hangzhou",
            ...
            "primary",
            "provisional",
            "Digital economy and cultural heritage benchmark included for tech-lifestyle balance and livability.",
        ),
        row(
            "jp-hiroshima",
            "Hiroshima",
        ...
        row(
            "kr-suwon",
            "Suwon",
            "Suwon Metropolitan Area",
            "South Korea",
            "East Asia",
            "primary",
            "provisional",
            "User anchor — strong challenger to Seoul with better livability, culture, and everyday quality.",
        ),
        row(
            "kr-jeju-city",
            "Jeju City",
        ...
        row(
            ...
            "primary",
            "provisional",
            "User anchor — cleanest and most organized Indian city with genuine livability and planning quality.",
        ),
        row(
            "lk-colombo",
            "Colombo",
        ...
        row(
            ...
            "primary",
            "provisional",
            "Italian economic benchmark included for productive depth, design-industry vitality, and high-pressure affordability tradeoffs.",
        ),
        row(
            "at-graz",
            "Graz",
        ...
        row(
            ...
            "secondary",
            "provisional",
            "Italian secondary-city challenger included for university depth, civic texture, walkability, and manageable metropolitan scale.",
        ),
        row(
            "ru-moscow",
            "Moscow",
...
RESERVE_CITY_UNIVERSE = [
    reserve_row(
        ...
        "Southeast Asia",
        "secondary",
        "Reserve Indonesian comparator added for a second-tier metro with realistic official-data coverage and a distinct affordability-services profile.",
    ),
    reserve_row(
        "ph-cebu-city",
        "Cebu City",
        ...
        "Southeast Asia",
        "secondary",
        "Reserve Philippine comparator added to widen the archipelago view beyond Metro Manila and test secondary-metro resilience.",
    ),
    reserve_row(
        "vn-da-nang",
        "Da Nang",
        ...
        "Southeast Asia",
        "secondary",
        "Reserve Vietnamese coastal comparator added for transport, public-space, and tourism-pressure benchmarking.",
    ),
    reserve_row(
        "kh-phnom-penh",
        "Phnom Penh",
        "Phnom Penh Capital Region",
        "Cambodia",
        "Southeast Asia",
        "primary",
        "Reserve capital comparator added to deepen mainland Southeast Asia coverage where official sources remain feasible.",
    ),
    reserve_row(
        "tw-taichung",
        "Taichung",
        ...
        "East Asia",
        "primary",
        "Reserve Taiwanese metro added for a lower-pressure manufacturing and services counterpoint to Taipei.",
    ),
    row(
        "tw-kaohsiung",
        "Kaohsiung",
        ...
        "primary",
        "locked",
        "User anchor — amazing in every way: port city with culture, food, climate, and livability.",
    ),
    reserve_row(
        "kr-incheon",
        "Incheon",
        ...
        "East Asia",
        "primary",
        "Reserve Korean metro added for airport-led connectivity and a distinct daily-livability profile outside Seoul's core gravity.",
    ),
    reserve_row(
        "cn-guangzhou",
        "Guangzhou",
        ...
        "East Asia",
        "primary",
        "Reserve Pearl River comparator added for manufacturing scale, trade, and high-capacity urban services.",
    ),
    reserve_row(
        "in-pune",
        "Pune",
        ...
        "South Asia",
        "primary",
        "Reserve Indian metro added for higher-skill employment, education depth, and lower-pressure contrast with larger Indian cores.",
    ),
    reserve_row(
        "pk-islamabad",
        "Islamabad",
        ...
        "South Asia",
        "primary",
        "Reserve Pakistani capital comparator added for a more administrative and planned urban profile than Karachi or Lahore.",
    ),
    reserve_row(
        "lk-kandy",
        "Kandy",
        ...
        "South Asia",
        "secondary",
        "Reserve Sri Lankan inland challenger added for cultural depth and a smaller-scale urban services comparison.",
    ),
    reserve_row(
        "np-pokhara",
        "Pokhara",
        ...
        "South Asia",
        "secondary",
        "Reserve Nepali challenger added for tourism, environmental pressure, and smaller-city everyday-livability comparison.",
    ),
    reserve_row(
        "cz-brno",
        "Brno",
        ...
        "Southern/Eastern Europe and Eurasia",
        "secondary",
        "Reserve Central European university-city comparator added for innovation depth outside capital-city dominance.",
    ),
    reserve_row(
        "si-ljubljana",
        "Ljubljana",
        ...
        "Southern/Eastern Europe and Eurasia",
        "primary",
        "Reserve small-capital comparator added for transit, human-scale urbanism, and strong administrative legibility.",
    ),
    reserve_row(
        "hr-zagreb",
        "Zagreb",
        ...
        "Southern/Eastern Europe and Eurasia",
        "primary",
        "Reserve Balkan capital comparator added for services, education, and regional gateway analysis.",
    ),
    reserve_row(
        "lt-vilnius",
        "Vilnius",
        ...
        "Southern/Eastern Europe and Eurasia",
        "primary",
        "Reserve Baltic capital comparator added for digital administration and smaller-market European competitiveness.",
    ),
    reserve_row(
        "lv-riga",
        "Riga",
        ...
        "Southern/Eastern Europe and Eurasia",
        "primary",
        "Reserve Baltic port-capital comparator added for logistics, housing pressure, and public-services benchmarking.",
    ),
    reserve_row(
        "ge-tbilisi",
        "Tbilisi",
        ...
        "Southern/Eastern Europe and Eurasia",
        "primary",
        "Reserve Caucasus capital comparator added for Eurasian crossover, reform visibility, and rapid-change testing.",
    ),
    reserve_row(
        "fr-lyon",
        "Lyon",
        ...
        "primary",
        "Reserve French metro added for a strong non-capital benchmark with credible official data and major service depth.",
    ),
    reserve_row(
        "es-valencia",
        "Valencia",
        ...
        "Western, Northern, and Southern Europe",
        "primary",
        "Reserve Mediterranean comparator added for climate, public life, and port-city livability tradeoffs.",
    ),
    reserve_row(
        "de-munich",
        "Munich",
        ...
        "Western, Northern, and Southern Europe",
        "primary",
        "Reserve German comparator added for high-productivity urban life with strong official and subnational data coverage.",
    ),
    reserve_row(
        "be-antwerp",
        "Antwerp",
        ...
        "Western, Northern, and Southern Europe",
        "secondary",
        "Reserve Benelux port-city comparator added for logistics, affordability, and cultural-public-life benchmarking.",
    ),
    reserve_row(
        "ie-cork",
        "Cork",
        ...
        "Western, Northern, and Southern Europe",
        "secondary",
        "Reserve Irish second-city comparator added for scale discipline and innovation-driven regional growth analysis.",
    ),
    reserve_row(
        "se-gothenburg",
        "Gothenburg",
        ...
        "Western, Northern, and Southern Europe",
        "primary",
        "Reserve Nordic port-metro added for strong welfare systems, housing pressure, and export-economy comparison.",
    ),
    reserve_row(
        "no-bergen",
        "Bergen",
        ...
        "Western, Northern, and Southern Europe",
        "secondary",
        "Reserve Norwegian challenger added for climate, public-services strength, and smaller-scale urban experience.",
    ),
    reserve_row(
        "nl-eindhoven",
        "Eindhoven",
        ...
        "Western, Northern, and Southern Europe",
        "secondary",
        "Reserve Dutch innovation-city comparator added for research intensity and productive specialization outside Amsterdam.",
    ),
    reserve_row(
        "ca-vancouver",
        "Vancouver",
        ...
        "North America",
        "primary",
        "Reserve Canadian Pacific comparator added for high-amenity urban life tested against acute housing pressure.",
    ),
    reserve_row(
        "ca-ottawa",
        "Ottawa",
        ...
        "North America",
        "primary",
        "Reserve Canadian capital comparator added for public-sector stability and bilingual institutional depth.",
    ),
    reserve_row(
        "us-minneapolis",
        "Minneapolis",
        ...
        "North America",
        "primary",
        "Reserve U.S. upper-midwest comparator added for strong services, education, and moderate-scale urban benchmarking.",
    ),
    reserve_row(
        "us-raleigh",
        "Raleigh",
        ...
        "North America",
        "secondary",
        "Reserve U.S. research-region comparator added for innovation, education, and fast-growth governance testing.",
    ),
    reserve_row(
        "do-santo-domingo",
        "Santo Domingo",
        ...
        "North America",
        "primary",
        "Reserve Caribbean capital comparator added for climate, tourism, and metropolitan services benchmarking.",
    ),
    reserve_row(
        "br-florianopolis",
        "Florianopolis",
        ...
        "Latin America",
        "secondary",
        "Reserve Brazilian coastal challenger added for innovation, safety tradeoffs, and quality-of-life comparison.",
    ),
    reserve_row(
        "pe-arequipa",
        "Arequipa",
        ...
        "Latin America",
        "secondary",
        "Reserve Peruvian second-city comparator added for altitude, affordability, and regional depth outside Lima.",
    ),
    reserve_row(
        "ec-cuenca",
        "Cuenca",
        "Cuenca Metropolitan Area",
        "Ecuador",
        "Latin America",
        "secondary",
        "Reserve Andean challenger added for lower-pressure city form, heritage, and retiree-inflow effects.",
    ),
    reserve_row(
        "py-asuncion",
        "Asuncion",
        ...
        "Latin America",
        "primary",
        "Reserve inland capital comparator added for under-covered Southern Cone urban economics and governance.",
    ),
    reserve_row(
        "il-haifa",
        "Haifa",
        ...
        "Middle East",
        "secondary",
        "Reserve Israeli port-city comparator added for industrial depth, coexistence testing, and hillside urban form.",
    ),
    reserve_row(
        "om-salalah",
        "Salalah",
        ...
        "Middle East",
        "secondary",
        "Reserve Omani secondary-city comparator added for climate seasonality and lower-pressure Gulf urban living.",
    ),
    reserve_row(
        "jo-aqaba",
        "Aqaba",
        ...
        "Middle East",
        "secondary",
        "Reserve Red Sea gateway comparator added for logistics, tourism, and smaller-scale Middle East benchmarking.",
    ),
    reserve_row(
        "sa-khobar",
        "Khobar",
        ...
        "Middle East",
        "secondary",
        "Reserve Gulf comparator added for private-sector employment, oil-economy transition, and cross-border business context.",
    ),
    reserve_row(
        "ma-rabat",
        "Rabat",
        "Rabat-Sale Metropolitan Area",
        "Morocco",
        "Africa",
        "primary",
        "Reserve North African capital comparator added for administrative competence and Atlantic urban quality comparisons.",
    ),
    reserve_row(
        "eg-alexandria",
        "Alexandria",
        ...
        "Africa",
        "primary",
        "Reserve Mediterranean African comparator added for port-city history, density, and climate-exposure tradeoffs.",
    ),
    reserve_row(
        "tz-dar-es-salaam",
        "Dar es Salaam",
        ...
        "Africa",
        "primary",
        "Reserve East African metro added for growth pressure, transport, and coastal services comparison.",
    ),
    reserve_row(
        "ug-kampala",
        "Kampala",
        ...
        "Africa",
        "primary",
        "Reserve Great Lakes capital comparator added for regional services, affordability pressure, and urban governance testing.",
    ),
    reserve_row(
        "gh-kumasi",
        "Kumasi",
        ...
        "Africa",
        "secondary",
        "Reserve Ghanaian secondary-city comparator added for inland services, education depth, and lower-cost urban life.",
    ),
    reserve_row(
        "nz-dunedin",
        "Dunedin",
        ...
        "Oceania",
        "secondary",
        "Reserve New Zealand challenger added for smaller-scale education-led urban life and colder-climate comparison.",
    ),
    reserve_row(
        "pg-port-moresby",
        "Port Moresby",
        "Port Moresby Metropolitan Area",
        "Papua New Guinea",
        "Oceania",
        "primary",
        "Reserve Melanesian capital comparator added so the Pacific reserve pool is not reduced to microstates and high-income systems.",
    ),
    reserve_row(
        "ws-apia",
        "Apia",
        ...
        "Oceania",
        "primary",
        "Reserve Polynesian capital comparator added for small-island services, climate resilience, and Pacific governance depth.",
    ),
    reserve_row(
        "vu-port-vila",
        "Port Vila",
        ...
        "Oceania",
        "primary",
        "Reserve Pacific capital comparator added for tourism, climate exposure, and utility-reliability benchmarking.",
    ),
]
...
def write_readme(
    ...
    rows = [
        ("Purpose", "This workbook is the operational source of truth for the global SLIC city ranking. Enter or import data into Country_Context and City_Inputs, then review Scores, Leaderboard, Region_Comparison, and the Thai-specific scaffold."),
        ("Official formula", "SLIC(c) = 0.25 Pressure + 0.22 Viability + 0.18 Capability + 0.15 Community + 0.20 Creative"),
...
def build_leaderboard_sheet(sheet: Worksheet, headers: list[str], score_headers: list[str], city_count: int) -> None:
    ...
    second_title_row = top_start_row + city_count
