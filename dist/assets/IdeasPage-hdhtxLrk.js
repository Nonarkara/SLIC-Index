...
if __name__ == "__main__":
    ...
    for s in stations:
        if s["pm25"] is not None:
            ...
            print()
    if not stations:
        print("  No stations returned. Check API key or city name.")`,repoHint:"See 'openaq/openaq-api' for the open air quality API, or 'breathe-free/breathe' for community air quality dashboards. Also search 'purple-air open-source' for sensor firmware.",tags:["air-quality","PM2.5","health","sensors","public-api","advisories"]}],m=[{value:"citizen-reporting",label:"Citizen Reporting"},{value:"smart-infrastructure",label:"Smart Infrastructure"},{value:"civic-ai",label:"Civic AI"},{value:"mobility",label:"Mobility"},{value:"sustainability",label:"Sustainability"},{value:"community",label:"Community"},{value:"governance",label:"Governance"},{value:"health",label:"Health"}],y={starter:"var(--accent-green)",intermediate:"var(--accent-amber)",advanced:"var(--accent-red)"};function b({text:d}){const[p,a]=r.useState(!1);function s(){navigator.clipboard.writeText(d).then(()=>{a(!0),setTimeout(()=>a(!1),2e3)})}return e.jsx("button",{type:"button",className:"idea-copy-btn",onClick:s,children:p?"Copied!":"Copy code"})}function k({onNavigate:d,locale:p}){const[a,s]=r.useState("all"),[i,l]=r.useState("all"),[c,g]=r.useState(null),u=r.useMemo(()=>{let t=[...f];return a!=="all"&&(t=t.filter(o=>o.category===a)),i!=="all"&&(t=t.filter(o=>o.difficulty===i)),t},[a,i]);return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:"rankings-hero section",children:e.jsxs("div",{className:"rankings-hero-grid",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"rankings-title",children:"Steal This Idea"}),e.jsx("p",{className:"hero-intro",children:"Real city innovations with working code you can copy, adapt, and deploy. Each idea comes from a real programme in a real city. The code snippets are starter templates you can drop into a no-code platform or build on directly."})]}),e.jsxs("div",{className:"rankings-controls",children:[e.jsxs("div",{className:"rankings-filter-group",children:[e.jsx("p",{className:"panel-label",children:"Category"}),e.jsxs("div",{className:"region-switch",role:"group","aria-label":"Idea category filter",children:[e.jsx("button",{type:"button",className:a==="all"?"region-button active":"region-button",onClick:()=>s("all"),children:"All"}),m.map(t=>e.jsx("button",{type:"button",className:a===t.value?"region-button active":"region-button",onClick:()=>s(t.value),children:t.label},t.value))]})]}),e.jsxs("div",{children:[e.jsx("p",{className:"panel-label",children:"Difficulty"}),e.jsxs("div",{className:"mode-switch",role:"group","aria-label":"Idea difficulty filter",children:[e.jsx("button",{type:"button",className:i==="all"?"mode-button active":"mode-button",onClick:()=>l("all"),children:"All"}),e.jsx("button",{type:"button",className:i==="starter"?"mode-button active":"mode-button",onClick:()=>l("starter"),children:"Starter"}),e.jsx("button",{type:"button",className:i==="intermediate"?"mode-button active":"mode-button",onClick:()=>l("intermediate"),children:"Intermediate"}),e.jsx("button",{type:"button",className:i==="advanced"?"mode-button active":"mode-button",onClick:()=>l("advanced"),children:"Advanced"})]})]})]})]})}),e.jsx("main",{children:e.jsxs("section",{className:"rankings-top section",children:[e.jsxs("div",{className:"section-heading",children:[e.jsxs("div",{children:[e.jsxs("p",{className:"eyebrow",children:[u.length," ideas"]}),e.jsx("h2",{children:"Copy, adapt, deploy"})]}),e.jsx("p",{className:"section-summary",children:"Click any card to reveal the working code snippet. Copy it directly or use it as a starting point."})]}),e.jsx("div",{className:"idea-grid",children:u.map(t=>{var o;return e.jsxs("article",{className:"idea-card",children:[e.jsx("div",{className:"idea-card-head",children:e.jsxs("div",{children:[e.jsxs("div",{className:"idea-card-meta",children:[e.jsx("span",{className:"idea-difficulty",style:{color:y[t.difficulty]},children:t.difficulty}),e.jsx("span",{className:"idea-category",children:(o=m.find(n=>n.value===t.category))==null?void 0:o.label})]}),e.jsx("h3",{children:t.title}),e.jsxs("p",{className:"city-location",children:[t.city,", ",t.country]})]})}),e.jsxs("p",{className:"idea-problem",children:[e.jsx("strong",{children:"Problem:"})," ",t.problem]}),e.jsxs("p",{className:"idea-solution",children:[e.jsx("strong",{children:"Solution:"})," ",t.solution]}),e.jsxs("p",{className:"idea-impact",children:[e.jsx("strong",{children:"Impact:"})," ",t.impact]}),e.jsx("div",{className:"metric-taglist",children:t.techStack.map(n=>e.jsx("span",{children:n},n))}),e.jsx("button",{type:"button",className:c===t.id?"idea-toggle active":"idea-toggle",onClick:()=>g(c===t.id?null:t.id),children:c===t.id?"Hide code":"Show code"}),c===t.id&&e.jsxs("div",{className:"idea-code-block",children:[e.jsxs("div",{className:"idea-code-header",children:[e.jsx("span",{children:"Starter code"}),e.jsx(b,{text:t.codeSnippet})]}),e.jsx("pre",{className:"idea-code",children:e.jsx("code",{children:t.codeSnippet})}),e.jsx("p",{className:"idea-repo-hint",children:t.repoHint})]}),e.jsx("div",{className:"metric-taglist",children:t.tags.map(n=>e.jsx("span",{children:n},n))})]},t.id)})})]})}),e.jsx(h,{onNavigate:d,locale:p})]})}export{k as default};
