...
if __name__ == "__main__":
    ...
    for s in stations:
        if s["pm25"] is not None:
            ...
            print()
    if not stations:
        print("  No stations returned. Check API key or city name.")`,repoHint:"See 'openaq/openaq-api' for the open air quality API, or 'breathe-free/breathe' for community air quality dashboards. Also search 'purple-air open-source' for sensor firmware.",tags:["air-quality","PM2.5","health","sensors","public-api","advisories"]}],y=[{value:"citizen-reporting",label:"Citizen Reporting"},{value:"smart-infrastructure",label:"Smart Infrastructure"},{value:"civic-ai",label:"Civic AI"},{value:"mobility",label:"Mobility"},{value:"sustainability",label:"Sustainability"},{value:"community",label:"Community"},{value:"governance",label:"Governance"},{value:"health",label:"Health"}];function h(i,n,c){i.preventDefault(),n(c)}const _={starter:"var(--accent-green)",intermediate:"var(--accent-amber)",advanced:"var(--accent-red)"};function j({text:i,ui:n}){const[c,o]=p.useState(!1);function a(){navigator.clipboard.writeText(i).then(()=>{o(!0),setTimeout(()=>o(!1),2e3)})}return e.jsx("button",{type:"button",className:"idea-copy-btn",onClick:a,children:c?n.copied:n.copyCode})}function T({onNavigate:i,locale:n,onLocaleChange:c}){const o=k(n),a=o.ideas,[d,g]=p.useState("all"),[r,u]=p.useState("all"),[m,b]=p.useState(null),f=p.useMemo(()=>{let t=[...x];return d!=="all"&&(t=t.filter(l=>l.category===d)),r!=="all"&&(t=t.filter(l=>l.difficulty===r)),t},[d,r]);return e.jsxs(e.Fragment,{children:[e.jsxs("header",{className:"rankings-hero section",children:[e.jsxs("div",{className:"topbar topbar-stack",children:[e.jsxs("div",{className:"topbar-left",children:[e.jsx("button",{type:"button",className:"back-arrow",onClick:()=>i("/"),"aria-label":"Back to home",children:"←"}),e.jsx(S,{eyebrow:a.eyebrow,microCopy:a.title})]}),e.jsxs("div",{className:"topbar-actions",children:[e.jsx(v,{locale:n,onChange:c}),e.jsxs("nav",{className:"topnav","aria-label":"Page navigation",children:[e.jsx("a",{href:"/",onClick:t=>h(t,i,"/"),children:o.nav.home}),e.jsx("a",{href:"/rankings",onClick:t=>h(t,i,"/rankings"),children:o.nav.rankings}),e.jsx("a",{href:"/methodology",onClick:t=>h(t,i,"/methodology"),children:o.nav.methodology})]})]})]}),e.jsxs("div",{className:"rankings-hero-grid",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"rankings-title",children:a.title}),e.jsx("p",{className:"hero-intro",children:a.intro})]}),e.jsxs("div",{className:"rankings-controls",children:[e.jsxs("div",{className:"rankings-filter-group",children:[e.jsx("p",{className:"panel-label",children:a.category}),e.jsxs("div",{className:"region-switch",role:"tablist",children:[e.jsx("button",{type:"button",className:d==="all"?"region-button active":"region-button",onClick:()=>g("all"),children:a.all}),y.map(t=>e.jsx("button",{type:"button",className:d===t.value?"region-button active":"region-button",onClick:()=>g(t.value),children:t.label},t.value))]})]}),e.jsxs("div",{children:[e.jsx("p",{className:"panel-label",children:a.difficulty}),e.jsxs("div",{className:"mode-switch",role:"tablist",children:[e.jsx("button",{type:"button",className:r==="all"?"mode-button active":"mode-button",onClick:()=>u("all"),children:a.all}),e.jsx("button",{type:"button",className:r==="starter"?"mode-button active":"mode-button",onClick:()=>u("starter"),children:a.difficultyLabels.starter}),e.jsx("button",{type:"button",className:r==="intermediate"?"mode-button active":"mode-button",onClick:()=>u("intermediate"),children:a.difficultyLabels.intermediate}),e.jsx("button",{type:"button",className:r==="advanced"?"mode-button active":"mode-button",onClick:()=>u("advanced"),children:a.difficultyLabels.advanced})]})]})]})]})]}),e.jsx("main",{children:e.jsxs("section",{className:"rankings-top section",children:[e.jsx("div",{className:"section-heading",children:e.jsxs("div",{children:[e.jsxs("p",{className:"eyebrow",children:[f.length," ",o.rankings.citiesLabel]}),e.jsx("h2",{children:a.summary})]})}),e.jsx("div",{className:"idea-grid",children:f.map(t=>{var l;return e.jsxs("article",{className:"idea-card",children:[e.jsx("div",{className:"idea-card-head",children:e.jsxs("div",{children:[e.jsxs("div",{className:"idea-card-meta",children:[e.jsx("span",{className:"idea-difficulty",style:{color:_[t.difficulty]},children:a.difficultyLabels[t.difficulty]}),e.jsx("span",{className:"idea-category",children:(l=y.find(s=>s.value===t.category))==null?void 0:l.label})]}),e.jsx("h3",{children:t.title}),e.jsxs("p",{className:"city-location",children:[t.city,", ",t.country]})]})}),e.jsxs("p",{className:"idea-problem",children:[e.jsxs("strong",{children:[a.problem,":"]})," ",t.problem]}),e.jsxs("p",{className:"idea-solution",children:[e.jsxs("strong",{children:[a.solution,":"]})," ",t.solution]}),e.jsxs("p",{className:"idea-impact",children:[e.jsxs("strong",{children:[a.impact,":"]})," ",t.impact]}),e.jsx("div",{className:"metric-taglist",children:t.techStack.map(s=>e.jsx("span",{children:s},s))}),e.jsx("button",{type:"button",className:m===t.id?"idea-toggle active":"idea-toggle",onClick:()=>b(m===t.id?null:t.id),children:m===t.id?a.hideCode:a.showCode}),m===t.id&&e.jsxs("div",{className:"idea-code-block",children:[e.jsxs("div",{className:"idea-code-header",children:[e.jsx("span",{children:a.starterCode}),e.jsx(j,{text:t.codeSnippet,ui:a})]}),e.jsx("pre",{className:"idea-code",children:e.jsx("code",{children:t.codeSnippet})}),e.jsx("p",{className:"idea-repo-hint",children:t.repoHint})]}),e.jsx("div",{className:"metric-taglist",children:t.tags.map(s=>e.jsx("span",{children:s},s))})]},t.id)})})]})}),e.jsx(w,{onNavigate:i,locale:n})]})}export{T as default};
