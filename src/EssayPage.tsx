...
const ABSTRACTS: Partial<Record<Locale, string[]>> = {
  ...
  ko: [
    ...
    "SLIC — 스마트 앤 생활가능 도시 지수 — 는 아마르티아 센의 역량 접근법에 더 가까운 것을 구축하려는 시도입니다. 저는 경제학자도, 정부도, 예산이 있는 연구 기관도 아닙니다. 방법론을 전부 공개하고, 모든 데이터를 무료로 제공하며, 멜버른이 중위 소득 가족에게 가장 살기 좋은 도시라는 생각에 지속적으로 이의를 제기하는 한 사람입니다.",
    "SLIC가 할 수 없는 것에 대해서도 솔직하게 말하겠습니다. 케니가 경험한 구체적인 무게, 첸이 8년 동안 쌓지 못한 것을 측정할 수 없습니다. 하지만 이러한 부재를 명명할 수는 있습니다. 싱가포르의 시민 자유 점수가 100점 만점에 39점이라는 사실은, 적어도 이 지수가 케니의 존재를 인식하고 있음을 의미합니다. 그 이상이 되기 위해 아직도 노력 중입니다.",
  ],
  ja: [
    "物語は2025年11月のナコンシータンマラートから始まります。洪水警報が10時間前に発令され、市職員は70台のCCTV連動ポンプ施設を稼働させ、市長は自ら浸水エリアに立って指揮を執りました。4万人の住民が数時間以内に避難情報を受け取りました。この出来事は、いかなる都市ランキングにも登場しません。EIUグローバル住居適性指数はPDF1部に935ドルを請求し、1990年から非公開の方法論で都市を評価し続けています。",
    "都市ランキングは、住民が実際に経験することを測定しません。ケニーはシンガポールの上級管理職です。彼の都市はあらゆる指数で優れた評価を受けています。しかし彼はゲイであり、自分のキャリアが静かに管理されてきたと信じています。陳は深センからブリュッセルに移住し、8年間住んでいる女性です。言語も話せ、子供たちも地域に溶け込んでいますが、ベルギー人の友人は一人もいません。都市ランキングは彼らの経験を捉えることができません。",
    "SLIC（スマート・アンド・リバブル・シティズ・インデックス）は、アマルティア・センのケイパビリティアプローチに近いものを構築しようとする試みです。私は経済学者でも、政府でも、予算を持つ研究機関でもありません。方法論を完全に公開し、すべてのデータを無料で提供し、メルボルンが中央値収入の家族にとって世界一住みやすい都市だという考えに継続的に異議を唱える一人の人間です。",
    "SLICができないことについても率直に述べます。ケニーが経験した具体的な重さや、陳が8年間で築けなかったものを測定することはできません。しかし、そのような欠如を名前付けることはできます。シンガポールの市民の自由スコアが100点中39点という事実は、少なくともこの指数がケニーの存在を認識していることを意味します。それ以上を目指して、今もまだ取り組んでいます。",
  ],
};
