...
export const ECHO_CHAMBER_NOTES: Record<string, EchoChamberNote> = {
  singapore: {
    slicRank: 8,
    en: "SLIC #8 under AMPI. Capability 94.1 is the highest in the dataset (healthcare, education, digital governance); Creative 73.3 and Viability 87.4 also top-tier. What limits Singapore is Community 47.8 — restricted civic freedoms and tolerance scores well below its wealth peers — plus working-time pressure in Growth. Even AMPI's imbalance penalty can't undo the structural strength here.",
    th: "SLIC อันดับ #8 ภายใต้ AMPI ศักยภาพ 94.1 สูงสุดในชุดข้อมูล (ระบบสุขภาพ การศึกษา ธรรมาภิบาลดิจิทัล) ความสร้างสรรค์ 73.3 และความน่าอยู่ 87.4 ก็ระดับสูง สิ่งที่จำกัดสิงคโปร์คือชุมชน 47.8 — เสรีภาพพลเมืองและความอดกลั้นต่ำกว่าคู่เทียบด้านรายได้ — รวมถึงชั่วโมงทำงานที่ยาว",
    zh: "AMPI 下 SLIC 第 8 名。能力支柱 94.1 是全数据集最高（医疗、教育、数字治理）；创意 73.3 与宜居 87.4 亦属顶级。拖累新加坡的是社区支柱 47.8 ——公民自由与包容性远低于其同等财富水平的城市——以及工时压力。",
  },
  zurich: {
    slicRank: 39,
    en: "SLIC #39 under AMPI. Viability 97.6 is near-perfect (safety, air, water, digital), Community 72.8 solid. But Growth 33.7 — disposable income after Swiss rents, graduate housing burden — and Creative 49.4 create enough variance that AMPI pulls the overall down. Zurich scores the way Zurich actually is: immaculate, moderately dynamic, crushingly expensive.",
    th: "SLIC อันดับ #39 ภายใต้ AMPI ความน่าอยู่ 97.6 ใกล้สมบูรณ์แบบ ชุมชน 72.8 ดี แต่ Growth 33.7 — รายได้คงเหลือหลังค่าเช่าสวิส ภาระที่อยู่อาศัย — และ Creative 49.4 สร้างความแปรปรวนจน AMPI ฉุดคะแนนรวมลง",
    zh: "AMPI 下 SLIC 第 39 名。宜居 97.6 接近完美，社区 72.8 稳健。但增长 33.7（瑞士房租后的可支配收入、毕业生住房负担）与创意 49.4 制造的方差足以令 AMPI 拉低总分。苏黎世得分如实：无可挑剔、中等活力、贵得令人窒息。",
  },
  copenhagen: {
    slicRank: 36,
    en: "SLIC #36 under AMPI. Community 89.3 is the dataset's strongest social-cohesion signal (tolerance, gender equality, social trust). Viability 97.9 matches Paris and Amsterdam at the top of the scale. But Growth 26.0 — Copenhagen's housing costs have risen sharply over the past decade — pulls AMPI down meaningfully.",
    th: "SLIC อันดับ #36 ภายใต้ AMPI ชุมชน 89.3 เป็นสัญญาณความสามัคคีทางสังคมที่แรงที่สุดในชุดข้อมูล ความน่าอยู่ 97.9 อยู่ระดับยอดเท่ากับ Paris และ Amsterdam แต่ Growth 26.0 — ค่าเช่าโคเปนเฮเกนเพิ่มขึ้นมากในทศวรรษที่ผ่านมา — ฉุด AMPI ลงอย่างมีนัย",
    zh: "AMPI 下 SLIC 第 36 名。社区 89.3 是整个数据集最强的社会凝聚信号。宜居 97.9 与巴黎、阿姆斯特丹并列榜首。但增长 26.0 ——哥本哈根过去十年房价大涨——明显拉低了 AMPI。",
  },
  sydney: {
    slicRank: 31,
    en: "SLIC #31 under AMPI. Viability 89.5 and Capability 87.1 are genuinely strong. The weight Sydney carries is Growth 31.0 — one of the world's most acute rent-to-income crises has been building for two decades. AMPI's pillar-imbalance penalty makes this visible: Sydney doesn't get to trade its housing catastrophe for beach and capability.",
    th: "SLIC อันดับ #31 ภายใต้ AMPI ความน่าอยู่ 89.5 และศักยภาพ 87.1 แข็งจริง ภาระของซิดนีย์คือ Growth 31.0 — วิกฤตค่าเช่าต่อรายได้ที่รุนแรงที่สุดแห่งหนึ่งของโลกสะสมมาสองทศวรรษ AMPI ทำให้เห็นชัด: ซิดนีย์แลกหายนะที่อยู่อาศัยกับหาดทรายและศักยภาพไม่ได้",
    zh: "AMPI 下 SLIC 第 31 名。宜居 89.5 与能力 87.1 确实强劲。悉尼背负的重担是增长 31.0 ——全球最严峻的房租收入比危机之一已累积二十年。AMPI 的失衡惩罚让这点清晰可见：悉尼不能用住房灾难换海滩与能力。",
  },
  vienna: {
    slicRank: 38,
    en: "SLIC #38 under AMPI. Viability 87.1, Capability 74.4, Community 70.7 — Vienna is consistently solid on the classic liveability frame. Creative 41.4 is the drag: Vienna's cultural reputation rests on historical capital more than current output, and the startup ecosystem is modest. AMPI tolerates this moderate imbalance.",
    th: "SLIC อันดับ #38 ภายใต้ AMPI เวียนนาแข็งสม่ำเสมอในกรอบความน่าอยู่คลาสสิก Creative 41.4 เป็นตัวถ่วง: ชื่อเสียงทางวัฒนธรรมพึ่งทุนประวัติศาสตร์มากกว่าผลผลิตปัจจุบัน",
    zh: "AMPI 下 SLIC 第 38 名。维也纳在经典宜居框架中各项稳健。创意 41.4 是拖累：文化声誉依赖历史积淀而非当下产出，创业生态规模有限。",
  },
  amsterdam: {
    slicRank: 56,
    en: "SLIC #56 under AMPI. Viability 97.6 is near-perfect, but Growth 31.4 and Creative 42.8 create pillar variance that AMPI penalises meaningfully. Tolerance indicators remain good but declining as housing pressure and migration tensions bite. Amsterdam under AMPI is no longer a top-40 city.",
    th: "SLIC อันดับ #56 ภายใต้ AMPI ความน่าอยู่ 97.6 ใกล้สมบูรณ์แบบ แต่ Growth 31.4 และ Creative 42.8 สร้างความแปรปรวนที่ AMPI ลงโทษ",
    zh: "AMPI 下 SLIC 第 56 名。宜居 97.6 接近完美，但增长 31.4 与创意 42.8 制造的方差被 AMPI 明显惩罚。包容性尚好但在住房与移民压力下下滑。在 AMPI 下阿姆斯特丹已不再是前 40 的城市。",
  },
  paris: {
    slicRank: 68,
    en: "SLIC #68 under AMPI. Viability 97.9 and Community 72.0 are excellent. Growth 23.1 is among the lowest of any G7 capital — housing burden, median-resident income negative after central rent, working-time pressure at the professional tier. AMPI punishes the extreme outlier: Paris cannot compensate for its affordability catastrophe with Viability and culture.",
    th: "SLIC อันดับ #68 ภายใต้ AMPI ความน่าอยู่ 97.9 และชุมชน 72.0 ยอดเยี่ยม Growth 23.1 ต่ำสุดในบรรดาเมืองหลวง G7 — ภาระค่าเช่า รายได้มัธยฐานติดลบ ชั่วโมงทำงานระดับวิชาชีพ AMPI ลงโทษค่าผิดปกติสุดขั้ว",
    zh: "AMPI 下 SLIC 第 68 名。宜居 97.9 与社区 72.0 出色。增长 23.1 是 G7 首都中最低之列——住房负担、中位居民可支配收入为负、职场工时压力。AMPI 惩罚极端离群值：巴黎无法用宜居与文化补偿其可负担性灾难。",
  },
  auckland: {
    slicRank: 32,
    en: "SLIC #32 under AMPI. Viability 92.6, Capability 85.7, Creative 63.1 — Auckland is genuinely pleasant. Growth 30.6 is the cost of one of the world's most acute housing-cost crises. AMPI keeps Auckland in the top third but not the top ten: the trade-off is visible rather than buried in the mean.",
    th: "SLIC อันดับ #32 ภายใต้ AMPI ความน่าอยู่ 92.6 ศักยภาพ 85.7 ความสร้างสรรค์ 63.1 — โอ๊กแลนด์น่าอยู่จริง Growth 30.6 คือราคาของวิกฤตค่าที่อยู่อาศัย AMPI ทำให้มองเห็นข้อแลกเปลี่ยนแทนที่จะซ่อนในค่าเฉลี่ย",
    zh: "AMPI 下 SLIC 第 32 名。宜居 92.6、能力 85.7、创意 63.1 ——奥克兰确实宜人。增长 30.6 是其全球最严峻房价危机之一的代价。AMPI 让奥克兰保持在前三分之一，但非前十：权衡被显现，而非埋没在均值中。",
  },
  // ── Global reference cities now in SLIC (added April 2026) ────────────────
  london: {
    slicRank: 35,
    en: "SLIC #35 under AMPI. The weighted mean of London's pillars is 65 — which would have placed it top-20 in a conventional index. AMPI's imbalance penalty drops it to 56.1 because Growth at 30.1 is so far below the other four pillars (60–78 range). For the median Londoner, central rent wipes out net salary before other essentials. London trades like a museum that's expensive to live inside.",
    th: "SLIC อันดับ #35 ภายใต้ AMPI ค่าเฉลี่ยถ่วงน้ำหนักของเสาลอนดอนอยู่ที่ 65 ซึ่งจะจัดอยู่ใน top-20 ของดัชนีทั่วไป แต่การลงโทษความไม่สมดุลของ AMPI ฉุดลงเป็น 56.1 เพราะ Growth ที่ 30.1 ต่ำกว่าเสาอื่น (60–78) มาก สำหรับคนลอนดอนทั่วไป ค่าเช่าใจกลางกินเงินเดือนสุทธิก่อนค่าใช้จ่ายอื่น ลอนดอนคือพิพิธภัณฑ์ที่แพงเหลือเกินถ้าอยากอยู่ข้างใน",
    zh: "AMPI 下 SLIC 第 35 名。伦敦五支柱的加权均值是 65 ——常规指数中这将置其于前 20。但 AMPI 的失衡惩罚将其拉至 56.1，因为增长支柱 30.1 远低于其他四柱（60–78）。对典型伦敦人而言，市中心房租在扣除其他必需开销前便吞没净薪。伦敦像一座住进去极为昂贵的博物馆。",
  },
  "new york": {
    slicRank: 34,
    en: "SLIC #34 under AMPI. Weighted-mean tells you NYC sits at 69 across five pillars — an apex city. AMPI tells you the weighted mean lies: Growth at 23.9 is such a catastrophic outlier against Capability 82 and Creative 75 that the overall score drops to 56.2. NYC still clears top-40, because its extraordinary pillars are genuine — but the city most mainstream indices rank top-5 is, under honest pillar-imbalance scoring, a middle-of-the-pack city for the median resident.",
    th: "AMPI ทำให้ SLIC ของ NYC อยู่อันดับ #34 ค่าเฉลี่ยถ่วงน้ำหนัก 69 จากห้าเสา — เมืองระดับยอด แต่ AMPI บอกว่าค่าเฉลี่ยโกหก: Growth 23.9 เป็นค่าผิดปกติรุนแรงเทียบกับ Capability 82 และ Creative 75 จนคะแนนรวมตกที่ 56.2 NYC ยังติด top-40 เพราะเสาที่แข็งของมันจริง แต่เมืองที่ดัชนีกระแสหลักจัดไว้ top-5 — เมื่อให้คะแนนความไม่สมดุลอย่างตรงไปตรงมา — คือเมืองระดับกลางสำหรับผู้อยู่อาศัยมัธยฐาน",
    zh: "AMPI 下 SLIC 第 34 名。加权均值告诉你纽约五支柱为 69 ——顶级城市。但 AMPI 揭穿了这个均值：增长 23.9 相对于能力 82 与创意 75 是灾难性的离群值，令总分降至 56.2。纽约仍居前 40 之列，因为它卓越的支柱是真实的——但主流指数排进前 5 的这座城市，在诚实衡量支柱失衡时，对中位数居民而言只是中游城市。",
  },
  tokyo: {
    slicRank: 50,
    en: "SLIC #50 under AMPI. Tokyo's Viability 94.2 is the highest of any top-60 city (homicide 0.25/100k, clean air, safe streets), but four pillars ranging 40–94 create high variance. The AMPI penalty lands Tokyo at 53.3. Growth 39.7 (long hours, severe suicide rate, moderate household debt) and Community 51.6 (restrictive LGBTQ+ legal environment) are the drag. Safer than New York; poorer for the median resident than Seoul or Fukuoka.",
    th: "SLIC อันดับ #50 ภายใต้ AMPI ความน่าอยู่ของโตเกียว 94.2 สูงสุดในกลุ่ม top-60 (ฆาตกรรม 0.25/100k อากาศสะอาด ถนนปลอดภัย) แต่เสาสี่ตัวอื่นอยู่ในช่วง 40–94 สร้างความแปรปรวนสูง AMPI ทำให้ได้ 53.3 Growth 39.7 (ชั่วโมงยาว ฆ่าตัวตายสูง หนี้ครัวเรือนปานกลาง) และ Community 51.6 (กรอบกฎหมาย LGBTQ+ จำกัด) เป็นตัวถ่วง ปลอดภัยกว่านิวยอร์ก จนกว่าผู้อยู่อาศัยมัธยฐานของโซลหรือฟุกุโอกะ",
    zh: "AMPI 下 SLIC 第 50 名。东京宜居支柱 94.2 是前 60 名最高（凶杀 0.25/10万、空气清洁、街道安全），但四根其他支柱跨度 40–94 产生高方差。AMPI 惩罚后得分为 53.3。增长 39.7（长工时、自杀率高、家庭债务中等）与社区 51.6（LGBTQ+ 法律环境受限）是拖累项。比纽约更安全；对中位居民而言不如首尔或福冈。",
  },
