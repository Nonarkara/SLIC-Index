...
export default function AwardsPage({
  ...
  const intro = t(
    ...
    "審査員向けの1ページ。4つの賞。同じ作品が4つの読み取りフレームで審査されます：編集出版、デザイン優秀性、クリエイティブテクノロジー、クリエイティブアドボカシー。",
  );
  ...
  const impactNote = t(
    ...
    "심사위원을 위한 증거 체크리스트. 공개 주장은 보수적으로 유지됩니다: 확인된 출연 및 인용 가능한 기록만 여기에 표시됩니다.",
    "審査員向けの証拠チェックリスト。公開の主張は保守的に維持されます：確認された出演と引用可能な記録のみここに掲載されています。",
  );
