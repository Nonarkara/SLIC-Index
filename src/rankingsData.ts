...
const cityScreenOverrides: Record<string, Partial<CityScreenProfile>> = {
  ...
  // ── Major new cities ──
  berlin: { safety: 84, affordability: 62, equality: 78, civicFreedom: 86, ecology: 74, crowding: 52 },
  ...
  stockholm: { safety: 88, affordability: 38, equality: 80, civicFreedom: 88, ecology: 82, crowding: 42 },
  ...
  osaka: { safety: 90, affordability: 62, equality: 74, civicFreedom: 84, ecology: 68, crowding: 68 },
...
const topCityOverrides: Record<string, CityOverride> = {
  ...
  busan: {
    ...
    scores: { pressure: 68, viability: 88, capability: 82, community: 78 },
    manifestStatus: "locked",
    cityType: "primary",
  ...
  bangkok: {
    ...
    scores: { pressure: 78, viability: 68, capability: 72, community: 85 },
    manifestStatus: "locked",
    cityType: "primary",
  ...
  kaohsiung: {
    ...
    scores: { pressure: 58, viability: 82, capability: 72, community: 85 },
    manifestStatus: "locked",
    cityType: "secondary",
  ...
  berlin: {
    ...
    scores: { pressure: 74, viability: 76, capability: 82, community: 92, creative: 91 },
    manifestStatus: "locked",
    cityType: "primary",
  ...
  stockholm: {
    ...
    scores: { pressure: 60, viability: 82, capability: 90, community: 68, creative: 88 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Nordic tech and design capital; benchmark for high creative output with strong welfare systems.",
    sentimentEmojis: ["👑", "💻", "🌲", "🎨", "❄️"],
    metrics: {
  ...
  osaka: {
    ...
    signal: "Stronger food culture and warmer social fabric than Tokyo, at lower cost.",
    delta: 2,
    tags: ["food", "culture", "affordable"],
    scores: { pressure: 68, viability: 92, capability: 86, community: 72, creative: 72 },
    manifestStatus: "locked",
    cityType: "primary",
  ...
  // ── Additional enriched city overrides ──
  ...
  singapore: {
    ...
    signal: "The city-state runs like a Swiss watch — clean, safe, hyper-efficient. But housing is government-allocated, creative friction is managed, and the social contract trades spontaneity for order. What other indices call 'livable,' residents sometimes call 'sterile.'",
    delta: -2,
    tags: ["efficiency", "controlled", "expensive"],
    scores: { pressure: 52, viability: 92, capability: 86, community: 55 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Benchmark city-state for top-down governance, safety, and the tension between efficiency and freedom.",
    sentimentEmojis: ["🏙️", "🌳", "🚇", "💰", "😐"],
    metrics: {
      pppIncomePerHead: 62000,
      graduateHousingShare: 42,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "World-class public hospitals with affordable copays, backed by Medisave and Medishield." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "Globally ranked universities and a hyper-competitive schooling pipeline from primary through polytechnic." },
  ...
  vienna: {
    ...
    signal: "Vienna tops every legacy index for a reason: social housing that actually works, universal healthcare, and a café culture that rewards slow mornings. But affordable it is not, creative it struggles to be, and if you are under 30 without family money, the beauty becomes background noise to the rent bill.",
    delta: -1,
    tags: ["social housing", "culture", "aging"],
    scores: { pressure: 48, viability: 94, capability: 82, community: 74 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "The perennial 'most livable' city in legacy indices; SLIC uses it to expose affordability and creative stagnation blind spots.",
    sentimentEmojis: ["☕", "🏛️", "🎶", "🏠", "😌"],
    metrics: {
      pppIncomePerHead: 38200,
      graduateHousingShare: 38,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "Comprehensive public system with minimal out-of-pocket for routine and specialist care." },
      education: { access: "Broad public access", affordability: "Free to low cost", summary: "Free university tuition and strong vocational pathways, though competition for spots is real." },
      experienceDiversity: 78,
    },
  },
  zurich: {
    ...
    signal: "Zurich is immaculate: trains run on time, lakes are swimmable, salaries are enormous. But mandatory health insurance costs CHF 400+/month, a flat dinner for two runs CHF 120, and social circles are notoriously closed. The city rewards those already inside the system.",
    delta: -3,
    tags: ["wealth", "precision", "exclusive"],
    scores: { pressure: 38, viability: 96, capability: 84, community: 58 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Stress-test for extreme wealth-livability tension; reveals how affordability erodes life quality even when everything else is excellent.",
    sentimentEmojis: ["⛰️", "💎", "🚂", "🏦", "😶"],
    metrics: {
      pppIncomePerHead: 52000,
      graduateHousingShare: 44,
      healthcare: { access: "Universal mandatory insurance", affordability: "High out-of-pocket", summary: "Excellent care quality but insurance premiums and deductibles create real monthly pressure." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "ETH Zürich alone makes this a global education hub; public schooling through secondary is strong." },
      experienceDiversity: 72,
    },
  },
  paris: {
    ...
    signal: "Paris still has the museums, the food, and the intellectual density that no other city matches. But a studio in the 11th costs more than a family flat in Taipei, commute times are brutal beyond the périphérique, and the bureaucracy is Kafka-grade. The city runs on cultural prestige and inherited apartments.",
    delta: -1,
    tags: ["culture", "bureaucracy", "unaffordable"],
    scores: { pressure: 42, viability: 78, capability: 80, community: 68 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Global cultural benchmark; reveals how prestige and creative heritage can coexist with severe affordability failure.",
    sentimentEmojis: ["🥐", "🎨", "🚇", "📜", "😤"],
    metrics: {
      pppIncomePerHead: 34800,
      graduateHousingShare: 42,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "Excellent public system backed by Sécurité sociale; specialist waits can be long but care quality is high." },
      education: { access: "Broad public access", affordability: "Free to low cost", summary: "Grandes écoles and public universities create a dual-track system; public options are strong but the elite pathway is narrow." },
  ...
  graz: {
    ...
    signal: "UNESCO City of Design with six universities feeding a surprisingly deep creative and tech economy. Rent is roughly half of Vienna, the old town is walkable in 20 minutes, and the Styrian food culture means dinner is both excellent and affordable. What it lacks in fame it gains in daily comfort.",
    delta: 3,
    tags: ["design", "affordable", "university"],
    scores: { pressure: 72, viability: 88, capability: 82, community: 80 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Proof that second cities in high-quality countries often deliver better daily life than their famous siblings.",
    sentimentEmojis: ["🎓", "🏔️", "🍷", "🎨", "😊"],
    metrics: {
      pppIncomePerHead: 34500,
      graduateHousingShare: 36,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "Same Austrian system as Vienna with shorter queues and easier GP access." },
      education: { access: "Broad public access", affordability: "Free to low cost", summary: "Six universities for a city of 300K creates an unusual density of academic infrastructure." },
      experienceDiversity: 76,
    },
  },
  porto: {
    ...
    signal: "Porto runs on a mix of creative migrants, cheap natural wine, and a startup scene that grew up in converted factories. The riverside is UNESCO-listed, the food is extraordinary, and rent — while rising fast — is still a fraction of Lisbon. The catch: salaries are Southern European, meaning the math only works if you earn remotely or own something.",
    delta: 2,
    tags: ["creative", "heritage", "wine"],
    scores: { pressure: 68, viability: 80, capability: 72, community: 82 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "European creative-class magnet showing how heritage, affordability, and lifestyle can coexist before gentrification fully arrives.",
    sentimentEmojis: ["🍷", "🌉", "🏗️", "🎶", "😋"],
    metrics: {
      pppIncomePerHead: 22800,
      graduateHousingShare: 30,
      healthcare: { access: "Universal public (SNS)", affordability: "Low cost", summary: "Public healthcare is free at point of use but wait times push many to affordable private clinics." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "University of Porto is well-ranked; tuition is under €1,000/year for EU students." },
      experienceDiversity: 82,
    },
  },
  braga: {
    ...
    signal: "Median age under 38, a university that punches above its weight in tech, and rent under €500 for a central flat. Braga is the kind of city that digital nomads discover three years before the lifestyle press. The baroque architecture, weekly markets, and proximity to wild Atlantic beaches don't hurt either.",
    delta: 4,
    tags: ["young", "tech", "affordable"],
    scores: { pressure: 74, viability: 82, capability: 72, community: 84 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Under-indexed European city demonstrating that youth, affordability, and quality of life can coexist outside capital cities.",
    sentimentEmojis: ["⛪", "💻", "🌊", "🍳", "😄"],
    metrics: {
      pppIncomePerHead: 20200,
      graduateHousingShare: 32,
      healthcare: { access: "Universal public (SNS)", affordability: "Low cost", summary: "Same Portuguese public system with less pressure than Lisbon or Porto." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "University of Minho is a strong regional anchor with growing CS and engineering reputation." },
      experienceDiversity: 72,
    },
  },
  tallinn: {
    ...
    signal: "Estonia built e-residency, digital voting, and paperless government before anyone else. Tallinn layers that on top of a preserved medieval old town, free public transport for residents, and a startup density per capita that rivals Tel Aviv. Winter is long and dark, but the sauna culture and summer white nights compensate.",
    delta: 3,
    tags: ["digital", "startup", "medieval"],
    scores: { pressure: 70, viability: 82, capability: 78, community: 72 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Global benchmark for digital governance and e-residency; proof that small-state innovation creates outsized livability dividends.",
    sentimentEmojis: ["💻", "🏰", "🧖", "🌲", "😎"],
    metrics: {
      pppIncomePerHead: 28600,
      graduateHousingShare: 34,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "Digital health records and universal coverage make routine care efficient; specialist depth is limited by population size." },
      education: { access: "Broad public access", affordability: "Free to low cost", summary: "Free university tuition for Estonian-language programs; TalTech anchors the tech education pipeline." },
  ...
  krakow: {
    ...
    signal: "Kraków has what Prague had 15 years ago — a stunning old town, a deep university culture, and prices that let you live well on a local salary. The tech outsourcing boom brought global companies but hasn't yet destroyed the character. Air quality in winter is the honest cost; everything else over-delivers.",
    delta: 2,
    tags: ["heritage", "tech", "affordable"],
    scores: { pressure: 72, viability: 78, capability: 76, community: 78 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Central European challenger showing how tech economy growth can coexist with heritage and affordability — before the Prague/Budapest pattern completes.",
    sentimentEmojis: ["🏰", "💻", "🍺", "📚", "😊"],
    metrics: {
      pppIncomePerHead: 26400,
      graduateHousingShare: 36,
      healthcare: { access: "Universal public (NFZ)", affordability: "Low cost", summary: "Universal coverage through NFZ but wait times push many to growing private sector; overall accessible." },
      education: { access: "Broad public access", affordability: "Free to low cost", summary: "Jagiellonian University is one of Europe's oldest; the city has 200K+ students for a population of 800K." },
      experienceDiversity: 80,
    },
  },
  budapest: {
    ...
    signal: "Budapest offers what few European capitals still can: a genuinely affordable, architecturally stunning city with world-class public baths, vibrant nightlife, and Danube views for €600/month rent. The thermal water culture alone is unique globally. But civic freedom scores reflect a tightening political environment that other indices politely ignore.",
    delta: 0,
    tags: ["thermal", "nightlife", "political tension"],
    scores: { pressure: 68, viability: 74, capability: 72, community: 72 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Tests whether lifestyle quality can compensate for democratic erosion — a question SLIC takes seriously.",
    sentimentEmojis: ["♨️", "🌉", "🍷", "🎭", "🤔"],
    metrics: {
      pppIncomePerHead: 24200,
      graduateHousingShare: 34,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "Universal coverage but underfunding means long waits; private sector is growing and affordable." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "Strong university tradition with affordable tuition; medical schools attract international students." },
      experienceDiversity: 84,
    },
  },
  helsinki: {
    ...
    country: "Finland",
    region: "Western, Northern, and Southern Europe",
    tagline: "Design thinking applied to daily life.",
    signal: "Finland's education system is globally famous, but what matters daily is the design ethos that permeates everything — public libraries that feel like museums, saunas in every apartment block, and a social contract that prioritizes equality over spectacle. Dark winters are real, and the city empties on summer Fridays for the archipelago.",
    delta: 1,
    tags: ["design", "education", "sauna"],
    scores: { pressure: 55, viability: 88, capability: 86, community: 74 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Global benchmark for education-driven livability and public design; tests whether the Nordic model delivers beyond the metrics.",
    sentimentEmojis: ["🧖", "📚", "🎨", "❄️", "😌"],
    metrics: {
      pppIncomePerHead: 35600,
      graduateHousingShare: 40,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "Comprehensive public healthcare with minimal copays; digital health services are among the best globally." },
      education: { access: "Universal public access", affordability: "Free", summary: "Free education through university including for many international programs; the system's equity is its defining feature." },
      experienceDiversity: 72,
    },
  },
  montreal: {
    ...
    country: "Canada",
    region: "North America",
    tagline: "North America's most European city — and its most affordable creative hub.",
    signal: "Montréal is what happens when French and English cultures collide productively: a city where artists can still afford studio space, comedians test material in two languages, and the food scene ranges from $4 bagels to Michelin-level without pretension. Housing is still affordable by North American standards. The winters are punishing but the cultural dividend is unmatched on the continent.",
    delta: 3,
    tags: ["bilingual", "creative", "affordable"],
    scores: { pressure: 68, viability: 76, capability: 80, community: 82 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "North America's best-case scenario for creative affordability; proof that cultural richness doesn't require New York prices.",
    sentimentEmojis: ["🎭", "🥯", "❄️", "🎵", "😊"],
    metrics: {
      pppIncomePerHead: 36200,
      graduateHousingShare: 38,
      healthcare: { access: "Universal public (RAMQ)", affordability: "Free", summary: "Quebec's single-payer system means no bills for doctor visits or hospital stays; wait times are the trade-off." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "McGill and UdeM make this a dual-language academic powerhouse; CEGEP system is uniquely accessible." },
      experienceDiversity: 90,
    },
  },
  pittsburgh: {
    ...
    signal: "Pittsburgh traded steel mills for robotics labs and medical research without losing its blue-collar soul. Carnegie Mellon and the University of Pittsburgh anchor a tech economy that's genuinely affordable — a three-bedroom house costs what a San Francisco parking spot does. The bridges, the Steelers, and the pierogi shops give it a texture that most 'innovation hubs' lack.",
    delta: 3,
    tags: ["reinvention", "tech", "affordable"],
    scores: { pressure: 72, viability: 76, capability: 80, community: 78 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Best American example of post-industrial reinvention; shows how knowledge economy growth can happen without pricing out the existing community.",
    sentimentEmojis: ["🌉", "🤖", "🏈", "🥟", "😤"],
    metrics: {
      pppIncomePerHead: 42000,
      graduateHousingShare: 34,
      healthcare: { access: "Mixed private-public", affordability: "High cost", summary: "UPMC is world-class but American insurance dynamics mean access depends heavily on employer coverage." },
      education: { access: "Broad access", affordability: "High cost", summary: "Carnegie Mellon and Pitt are globally ranked but tuition follows American norms; public K-12 is uneven by district." },
      experienceDiversity: 76,
    },
  },
  chicago: {
    ...
    country: "United States",
    region: "North America",
    tagline: "Architecture, blues, and the sharpest inequality in America.",
    signal: "Chicago has the best architecture in the Western Hemisphere, a food scene that embarrasses both coasts, and neighborhoods with genuine character. But it's also America's inequality in one city — the South and West sides operate in a different country from Lincoln Park. The violence is real, concentrated, and the result of policy choices that SLIC measures directly.",
    delta: -1,
    tags: ["architecture", "inequality", "culture"],
    scores: { pressure: 62, viability: 64, capability: 74, community: 68 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Essential for showing how aggregate livability scores can hide neighborhood-level inequality — a blind spot in every competing index.",
    sentimentEmojis: ["🏙️", "🎵", "🌭", "🏛️", "😬"],
    metrics: {
      pppIncomePerHead: 48000,
      graduateHousingShare: 36,
      healthcare: { access: "Mixed private-public", affordability: "High cost", summary: "World-class medical centers on the North Side; access on the South Side is a different story entirely." },
      education: { access: "Mixed access", affordability: "High cost", summary: "University of Chicago, Northwestern nearby, strong community colleges — but K-12 quality follows zip code." },
      experienceDiversity: 88,
    },
  },
  toronto: {
    ...
    country: "Canada",
    region: "North America",
    tagline: "The immigration experiment that priced itself out.",
    signal: "Toronto is genuinely the most multicultural city on Earth — over half the population is foreign-born, and it works. The food is extraordinary, the neighborhoods are distinct, and the social infrastructure absorbs diversity better than anywhere. But housing costs have doubled in a decade, and young Canadians increasingly can't afford the city their parents built.",
    delta: -1,
    tags: ["multicultural", "housing crisis", "immigration"],
    scores: { pressure: 45, viability: 78, capability: 80, community: 76 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "World's best-case immigration city now stress-tested by housing unaffordability; SLIC captures the tension other indices miss.",
    sentimentEmojis: ["🌍", "🏠", "🍜", "🏒", "😰"],
    metrics: {
      pppIncomePerHead: 38400,
      graduateHousingShare: 40,
      healthcare: { access: "Universal public (OHIP)", affordability: "Free", summary: "Universal coverage with no direct cost for doctor visits; specialist waits are among the longest in the developed world." },
      education: { access: "Broad public access", affordability: "Moderate cost", summary: "U of T is globally ranked; public K-12 is strong and equitable compared to American peers." },
      experienceDiversity: 92,
    },
  },
  vancouver: {
    ...
    country: "Canada",
    region: "North America",
    tagline: "Mountains, ocean, and the worst housing math in North America.",
    signal: "Vancouver is physically stunning — ski in the morning, kayak in the afternoon. But the city has become a cautionary tale: foreign capital inflows turned housing into a speculative asset, and a barista-to-rent ratio that would make London blush. If you own, it's paradise. If you don't, the mountains become ironic.",
    delta: -3,
    tags: ["nature", "housing crisis", "scenic"],
    scores: { pressure: 35, viability: 84, capability: 76, community: 68 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Case study in how natural beauty and high viability can coexist with catastrophic housing affordability failure.",
    sentimentEmojis: ["⛰️", "🌊", "🏠", "🚴", "😩"],
    metrics: {
      pppIncomePerHead: 36800,
      graduateHousingShare: 38,
      healthcare: { access: "Universal public (MSP)", affordability: "Free", summary: "BC's public system covers basics but finding a family doctor is increasingly difficult in the metro area." },
      education: { access: "Broad public access", affordability: "Moderate cost", summary: "UBC is world-class; public schooling is strong but the city's cost of living pressures family formation." },
      experienceDiversity: 78,
    },
  },
  "san-francisco": {
    ...
    country: "United States",
    region: "North America",
    tagline: "Where ideas become industries — and rents become absurd.",
    signal: "San Francisco has the highest startup density on Earth and a cultural DNA that rewards risk-taking. But the wealth has created a parallel city: tech workers in $4,000/month studios, tents on the sidewalk outside, and a middle class that commutes 90 minutes from the East Bay. The city runs on ambition and cognitive dissonance.",
    delta: -2,
    tags: ["startup", "inequality", "innovation"],
    scores: { pressure: 30, viability: 68, capability: 88, community: 60 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Global innovation benchmark; reveals how creative density can coexist with extreme livability failure for non-tech residents.",
    sentimentEmojis: ["💡", "🌁", "💰", "🏕️", "😵"],
    metrics: {
      pppIncomePerHead: 72000,
      graduateHousingShare: 48,
      healthcare: { access: "Mixed private-public", affordability: "Very high cost", summary: "UCSF is world-class but American insurance dynamics mean everything depends on your employer." },
      education: { access: "Mixed access", affordability: "Very high cost", summary: "Stanford and Berkeley nearby; K-12 follows American zip-code patterns." },
      experienceDiversity: 86,
    },
  },
  "chiang-mai": {
    ...
    signal: "Chiang Mai invented the 'work from anywhere' lifestyle before co-working was a category. Excellent coffee, $2 street meals, fast fiber internet, and a Lanna cultural depth that most visitors never discover. The burning season (Feb-Apr) is the honest cost. The rest of the year, it's hard to beat the lifestyle-to-cost ratio anywhere on Earth.",
    delta: 4,
    tags: ["nomad", "culture", "affordable"],
    scores: { pressure: 82, viability: 72, capability: 66, community: 84 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Global benchmark for remote-work livability; shows how secondary cities can attract global talent through affordability and culture rather than corporate headquarters.",
    sentimentEmojis: ["☕", "🏯", "💻", "🌿", "😊"],
    metrics: {
      pppIncomePerHead: 14200,
      graduateHousingShare: 22,
      healthcare: { access: "Broad mixed access", affordability: "Low cost", summary: "Private hospitals offer excellent care at a fraction of Western prices; dental tourism is a real industry." },
      education: { access: "Broad public-private mix", affordability: "Low cost", summary: "Chiang Mai University anchors the city; international schools serve the growing expat community." },
      experienceDiversity: 84,
    },
  },
  kuching: {
    ...
    signal: "Kuching is what happens when a city stays small enough to be walkable, diverse enough to serve laksa and kolo mee on the same street, and connected enough to Borneo's rainforest that wildlife is a weekend trip, not a documentary. The Sarawak government runs semi-autonomously from KL, which gives the city a distinct civic character.",
    delta: 4,
    tags: ["nature", "food", "autonomous"],
    scores: { pressure: 78, viability: 76, capability: 66, community: 84 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Southeast Asia's strongest case for small-city livability; challenges the assumption that quality of life requires scale.",
    sentimentEmojis: ["🐱", "🌴", "🍜", "🦎", "😄"],
    metrics: {
      pppIncomePerHead: 18600,
      graduateHousingShare: 26,
      healthcare: { access: "Broad mixed access", affordability: "Low cost", summary: "Government and private hospitals cover basics well; specialist care may require travel to KL." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "UNIMAS provides the university anchor; schooling options are solid if not spectacular." },
      experienceDiversity: 76,
    },
  },
  "george-town": {
    ...
    country: "Malaysia",
    region: "Southeast Asia",
    tagline: "Street art, street food, and three cultures in one square mile.",
    signal: "UNESCO World Heritage status preserved what developers would have demolished: a living fusion of Malay, Chinese, Indian, and colonial British cultures in walkable streets. The hawker food is world-class and costs under $3. The tech and manufacturing economy (Penang is Malaysia's Silicon Valley) means jobs exist beyond tourism.",
    delta: 3,
    tags: ["heritage", "food", "multicultural"],
    scores: { pressure: 74, viability: 74, capability: 64, community: 82 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "UNESCO heritage city with genuine economic substance; shows how cultural preservation and modern industry can reinforce each other.",
    sentimentEmojis: ["🎨", "🍜", "🏛️", "💻", "😋"],
    metrics: {
      pppIncomePerHead: 20400,
      graduateHousingShare: 28,
      healthcare: { access: "Broad mixed access", affordability: "Low cost", summary: "Penang's medical tourism industry means private hospitals compete on both price and quality." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "Strong school system and proximity to USM; international school options growing." },
      experienceDiversity: 86,
    },
  },
  "ho-chi-minh-city": {
    ...
    country: "Vietnam",
    region: "Southeast Asia",
    tagline: "The motorcycle city that moves faster than its regulations.",
    signal: "Saigon runs on controlled chaos — 9 million motorbikes, a coffee culture that rivals Italy's, and an economy growing at 7%+ that you can feel in every new tower and every packed sidewalk restaurant. Civic freedom constraints are real but the economic energy is unmistakable. The city rewards adaptability.",
    delta: 2,
    tags: ["growth", "street life", "coffee"],
    scores: { pressure: 76, viability: 62, capability: 66, community: 78 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Southeast Asia's fastest-moving economy city; benchmark for growth energy, street-level livability, and the friction between economic freedom and political constraint.",
    sentimentEmojis: ["🛵", "☕", "🍲", "🏗️", "😤"],
    metrics: {
      pppIncomePerHead: 12800,
      graduateHousingShare: 28,
      healthcare: { access: "Mixed public-private", affordability: "Low cost", summary: "Growing private hospital network; public system is accessible but quality varies significantly." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "Growing university sector with international partnerships; vocational training is undervalued but effective." },
      experienceDiversity: 82,
    },
  },
  santiago: {
    ...
    signal: "Santiago is what happens when a South American capital gets the basics right: a functioning metro, drinkable tap water, and a pension system that — while controversial — actually exists. The Andes backdrop is dramatic, the wine is world-class, and the startup scene is the continent's most mature. Air quality in winter and inequality remain honest costs.",
    delta: 1,
    tags: ["stability", "wine", "inequality"],
    scores: { pressure: 62, viability: 74, capability: 72, community: 70 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Latin America's infrastructure and governance benchmark; shows what's possible when a developing economy prioritizes institutional reliability.",
    sentimentEmojis: ["🏔️", "🍷", "🚇", "📊", "😐"],
    metrics: {
      pppIncomePerHead: 22600,
      graduateHousingShare: 32,
      healthcare: { access: "Mixed public-private (Fonasa/Isapre)", affordability: "Moderate cost", summary: "Dual system where quality tracks income; public system covers basics, private covers comfort." },
      education: { access: "Broad access", affordability: "Moderate to high cost", summary: "PUC and Universidad de Chile are regionally strong; student debt protests reflect real affordability pressure." },
      experienceDiversity: 78,
    },
  },
  montevideo: {
    ...
    signal: "Uruguay is the continent's most stable democracy, and Montevideo is its low-key capital: safe by regional standards, socially progressive (legal cannabis, same-sex marriage early), and with a rambla (waterfront promenade) that gives every resident access to the Río de la Plata. The economy is small, and ambition may feel capped — but for those who value calm over growth, it delivers.",
    delta: 2,
    tags: ["stable", "progressive", "waterfront"],
    scores: { pressure: 64, viability: 76, capability: 70, community: 78 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Latin America's best case for democratic stability and social progressivism; shows that livability doesn't require economic scale.",
    sentimentEmojis: ["🌊", "🧉", "🏛️", "🌈", "😌"],
    metrics: {
      pppIncomePerHead: 19800,
      graduateHousingShare: 30,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "Public-private hybrid through mutualistas system; coverage is broad and reasonably reliable." },
      education: { access: "Broad public access", affordability: "Free", summary: "Universidad de la República is free and open-admission; quality is decent and improving." },
      experienceDiversity: 72,
    },
  },
  medellin: {
    ...
    signal: "Medellín went from the world's murder capital to a design-award-winning city in 25 years. The cable cars connecting hillside comunas to the metro are engineering marvels with social purpose. The weather is eternal spring (1,500m altitude), the cost of living is genuinely low, and the creative energy is palpable. Safety has improved dramatically but isn't yet where locals want it.",
    delta: 2,
    tags: ["transformation", "design", "spring"],
    scores: { pressure: 72, viability: 66, capability: 64, community: 78 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Global benchmark for urban transformation; tests whether infrastructure investment can permanently change a city's livability trajectory.",
    sentimentEmojis: ["🚡", "🌺", "🎨", "☕", "💪"],
    metrics: {
      pppIncomePerHead: 14600,
      graduateHousingShare: 28,
      healthcare: { access: "Broad mixed access", affordability: "Low cost", summary: "Colombia's EPS system provides universal coverage; Medellín has some of the continent's best hospitals." },
      education: { access: "Broad public-private mix", affordability: "Low to moderate cost", summary: "EAFIT and Universidad de Antioquia anchor a growing education sector; quality is rising." },
      experienceDiversity: 80,
    },
  },
  curitiba: {
    ...
    signal: "Curitiba wrote the textbook on sustainable urban planning in the 1970s and the BRT system inspired cities worldwide. The parks, the pedestrian streets, and the recycling programs actually work at scale. It's Brazil's most European-feeling city (heavy German, Italian, Ukrainian immigration) with a quality of life that outperforms cities twice its GDP.",
    delta: 2,
    tags: ["planning", "transit", "green"],
    scores: { pressure: 70, viability: 72, capability: 68, community: 74 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Global urban planning benchmark; proof that design-led infrastructure investment creates lasting livability dividends even in developing economies.",
    sentimentEmojis: ["🚌", "🌳", "🇧🇷", "♻️", "😊"],
    metrics: {
      pppIncomePerHead: 18200,
      graduateHousingShare: 30,
      healthcare: { access: "Universal public (SUS)", affordability: "Free", summary: "Brazil's SUS provides universal coverage; Curitiba's implementation is above the national average." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "UFPR and PUC-PR provide solid university options; technical education is particularly strong." },
      experienceDiversity: 74,
    },
  },
  dubai: {
    ...
    region: "Middle East",
    tagline: "The world's most ambitious stage set.",
    signal: "Dubai built the tallest building, the largest mall, and artificial islands — then filled them with people from 200 countries who came for tax-free salaries and left their civic rights at the airport. The infrastructure is genuinely world-class, the safety is real, and the 45°C summers are endured for the economics. But tolerance scores reflect a social contract that works for professionals and struggles for laborers.",
    delta: -2,
    tags: ["spectacle", "tax-free", "constructed"],
    scores: { pressure: 58, viability: 82, capability: 72, community: 42 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Stress-test for built-environment livability without civic freedom; reveals how safety and infrastructure can coexist with low community and tolerance scores.",
    sentimentEmojis: ["🏗️", "☀️", "💰", "🛍️", "😎"],
    metrics: {
      pppIncomePerHead: 44000,
      graduateHousingShare: 38,
      healthcare: { access: "Strong urban access", affordability: "Moderate cost", summary: "Mandatory insurance for residents; quality is high in private facilities but costs can escalate." },
      education: { access: "Mixed access", affordability: "Moderate to high cost", summary: "International schools dominate; quality varies enormously and tuition ranges from affordable to astronomical." },
      experienceDiversity: 72,
    },
  },
  "tel-aviv": {
    ...
    country: "Israel",
    region: "Middle East",
    tagline: "Startup nation on the Mediterranean — with a conflict overhead.",
    signal: "Tel Aviv has more startups per capita than anywhere except maybe San Francisco, a beach culture that rivals Barcelona's, and a food scene built by immigration from 70 countries. It's also the most expensive city in the Middle East, the security situation is ever-present, and the political context makes 'livability' a loaded word. SLIC measures what's there, not what's wished.",
    delta: -1,
    tags: ["startup", "beach", "conflict"],
    scores: { pressure: 42, viability: 72, capability: 82, community: 65 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Innovation benchmark in a conflict zone; tests how creative economy and security tension coexist in the same ranking.",
    sentimentEmojis: ["🏖️", "💡", "🥙", "🎯", "😬"],
    metrics: {
      pppIncomePerHead: 36400,
      graduateHousingShare: 40,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "Israel's universal healthcare system is efficient and well-funded; routine care is excellent." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "Technion and Tel Aviv University are world-class; mandatory military service delays but doesn't diminish academic culture." },
      experienceDiversity: 84,
    },
  },
  kigali: {
    ...
    signal: "Kigali banned plastic bags in 2008, runs monthly community clean-up days (umuganda) that are mandatory, and has a murder rate lower than many European capitals. The transformation from 1994 is almost incomprehensible. The trade-off is political freedom — the discipline that created the cleanliness also limits dissent. Other indices ignore African cities entirely; SLIC measures what's real.",
    delta: 3,
    tags: ["clean", "discipline", "transformation"],
    scores: { pressure: 68, viability: 72, capability: 62, community: 70 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Africa's most dramatic urban transformation story; challenges every assumption about what 'developing world' cities can achieve.",
    sentimentEmojis: ["🌿", "🧹", "🏔️", "☕", "💪"],
    metrics: {
      pppIncomePerHead: 5800,
      graduateHousingShare: 24,
      healthcare: { access: "Broad community-based insurance", affordability: "Low cost", summary: "Mutuelle de Santé covers 90%+ of the population; quality is basic but access is remarkably wide for the income level." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "Education is compulsory and free through secondary; university options are growing but still limited." },
      experienceDiversity: 62,
    },
  },
  "cape-town": {
    ...
    signal: "Cape Town is physically one of the most beautiful cities on Earth — Table Mountain, two oceans, wine country 30 minutes away. The creative scene, from art to music to food, is genuinely world-class. But it's also the most unequal city in one of the most unequal countries: the distance from Camps Bay to Khayelitsha is 30 km and 30 years of development difference.",
    delta: -1,
    tags: ["scenic", "inequality", "creative"],
    scores: { pressure: 60, viability: 54, capability: 58, community: 64 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Africa's most visible city internationally; tests how natural beauty and creative culture score when measured against infrastructure and equality.",
    sentimentEmojis: ["⛰️", "🌊", "🎨", "⚡", "🤔"],
    metrics: {
      pppIncomePerHead: 16200,
      graduateHousingShare: 28,
      healthcare: { access: "Mixed public-private", affordability: "Moderate cost", summary: "Private healthcare is excellent; public system serves the majority but is severely under-resourced." },
      education: { access: "Mixed access", affordability: "Low to moderate cost", summary: "UCT is Africa's top-ranked university; public schooling quality varies dramatically by district." },
      experienceDiversity: 82,
    },
  },
  nairobi: {
    ...
    signal: "Nairobi invented mobile money (M-Pesa), hosts more tech startups than any other African city, and has a creative and media scene that punches above its GDP. The traffic is legendary, the infrastructure gaps are real, but the energy and ambition are unmistakable. This is where Africa's digital economy is being built, one potholed road at a time.",
    delta: 1,
    tags: ["tech", "M-Pesa", "ambition"],
    scores: { pressure: 64, viability: 52, capability: 58, community: 68 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Africa's most important tech city; benchmark for how digital innovation can run ahead of physical infrastructure.",
    sentimentEmojis: ["📱", "🦁", "💻", "🚗", "💪"],
    metrics: {
      pppIncomePerHead: 8400,
      graduateHousingShare: 26,
      healthcare: { access: "Mixed public-private", affordability: "Low to moderate cost", summary: "Private hospitals serve the professional class well; public system is stretched but NHIF provides basic coverage." },
      education: { access: "Broad public-private mix", affordability: "Low cost", summary: "University of Nairobi and Strathmore anchor a growing education sector; tech bootcamps are filling gaps." },
      experienceDiversity: 74,
    },
  },
  sydney: {
    ...
    country: "Australia",
    region: "Oceania",
    tagline: "Harbour views that cost more than most cities' salaries.",
    signal: "Sydney has the harbor, the Opera House, and a quality of life that's genuinely excellent if you can afford it. But median house prices exceed 13x median income — the worst ratio in the anglophone world after Hong Kong. The result is a city of long commutes from distant suburbs, where the people who keep the city running can't afford to live near it.",
    delta: -2,
    tags: ["harbour", "unaffordable", "lifestyle"],
    scores: { pressure: 38, viability: 82, capability: 76, community: 68 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Anglosphere housing crisis benchmark; shows how high viability and low affordability create a two-tier city.",
    sentimentEmojis: ["🌊", "🏠", "☀️", "🦘", "😰"],
    metrics: {
      pppIncomePerHead: 42000,
      graduateHousingShare: 40,
      healthcare: { access: "Universal public (Medicare)", affordability: "Low cost", summary: "Medicare covers basics; private health insurance is common and tax-incentivized for higher earners." },
      education: { access: "Broad public access", affordability: "Moderate cost", summary: "USyd and UNSW are globally ranked; public schooling is strong but the system is increasingly stratified." },
      experienceDiversity: 82,
    },
  },
  melbourne: {
    ...
    country: "Australia",
    region: "Oceania",
    tagline: "Australia's cultural capital — perpetually arguing with Sydney.",
    signal: "Melbourne has the coffee, the laneways, the live music, and the sport. It's genuinely the cultural capital of Australia in the same way that Barcelona is Spain's. Slightly more affordable than Sydney (which is a low bar), with better public transport and a grittier, more creative energy. The weather is famously four-seasons-in-one-day.",
    delta: 0,
    tags: ["coffee", "culture", "sport"],
    scores: { pressure: 42, viability: 80, capability: 76, community: 72 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Australia's cultural benchmark; complements Sydney by showing how creative culture and livability relate differently when housing pressure is marginally lower.",
    sentimentEmojis: ["☕", "🎭", "🏏", "🌧️", "😊"],
    metrics: {
      pppIncomePerHead: 40000,
      graduateHousingShare: 38,
      healthcare: { access: "Universal public (Medicare)", affordability: "Low cost", summary: "Same Medicare system as Sydney with somewhat better GP access outside the CBD." },
      education: { access: "Broad public access", affordability: "Moderate cost", summary: "University of Melbourne is consistently top-ranked; TAFE system provides strong vocational pathways." },
      experienceDiversity: 84,
    },
  },
  brisbane: {
    ...
    country: "Australia",
    region: "Oceania",
    tagline: "Subtropical growth with the 2032 Olympics on the horizon.",
    signal: "Brisbane is Australia's fastest-growing capital — subtropical climate, outdoor lifestyle, and housing that's 40% cheaper than Sydney. The 2032 Olympics infrastructure investment is already reshaping the city. It lacks the cultural density of Melbourne or the harbour drama of Sydney, but for everyday life with sunshine, it over-delivers.",
    delta: 2,
    tags: ["growth", "subtropical", "Olympics"],
    scores: { pressure: 58, viability: 80, capability: 72, community: 70 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "Australia's growth city; tests whether Olympic-driven infrastructure investment creates lasting livability or temporary prestige.",
    sentimentEmojis: ["☀️", "🏊", "🏗️", "🌴", "😊"],
    metrics: {
      pppIncomePerHead: 38000,
      graduateHousingShare: 36,
      healthcare: { access: "Universal public (Medicare)", affordability: "Low cost", summary: "Good Medicare coverage with growing private options; less specialist congestion than Sydney." },
      education: { access: "Broad public access", affordability: "Moderate cost", summary: "UQ is well-ranked; the city benefits from less educational stratification than the southern capitals." },
      experienceDiversity: 72,
    },
  },
  sapporo: {
    ...
    signal: "Sapporo is where Hokkaido's dairy, seafood, and agriculture converge with Japanese urban precision. The ramen is arguably Japan's best, the beer is the country's oldest brand, and the powder snow draws visitors worldwide. Housing is remarkably cheap for a Japanese city of 2 million. The summers are cool and the winters are epic — this is Japan's most livable climate escape.",
    delta: 3,
    tags: ["food", "snow", "affordable"],
    scores: { pressure: 72, viability: 86, capability: 78, community: 76 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Japan's best affordable-livability proposition; shows how climate, food culture, and reasonable prices create a quality-of-life outlier.",
    sentimentEmojis: ["🍜", "❄️", "🍺", "🏔️", "😊"],
    metrics: {
      pppIncomePerHead: 28800,
      graduateHousingShare: 26,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "National health insurance with the usual Japanese efficiency; Hokkaido University Hospital anchors specialist care." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "Hokkaido University is a former Imperial university with strong research credentials." },
      experienceDiversity: 78,
    },
  },
  hiroshima: {
    ...
    country: "Japan",
    region: "East Asia",
    tagline: "Peace, okonomiyaki, and a city rebuilt on moral purpose.",
    signal: "Hiroshima is the only city on Earth whose identity was forged by destruction and rebuilt on a commitment to peace. The Peace Memorial Park gives the city a moral gravity that's unique globally. Beyond the symbolism, it's a compact, affordable, well-connected Japanese city with excellent public transport and Miyajima island 30 minutes away.",
    delta: 2,
    tags: ["peace", "compact", "resilient"],
    scores: { pressure: 70, viability: 86, capability: 78, community: 78 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Unique globally for identity rebuilt on moral purpose; Japanese second-city livability at its most distinctive.",
    sentimentEmojis: ["☮️", "🍳", "⛩️", "🚃", "😊"],
    metrics: {
      pppIncomePerHead: 29200,
      graduateHousingShare: 26,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "National insurance system with good local hospital network; compact size means access is easy." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "Hiroshima University provides the academic anchor; the city's education ethos is shaped by its peace mission." },
      experienceDiversity: 74,
    },
  },
  taichung: {
    ...
    signal: "Taichung is where Taiwanese go when Taipei feels too compressed and Kaohsiung feels too industrial. The climate is milder, the housing is genuinely affordable, and the National Taichung Theater alone justifies the city's creative credentials. Bubble tea was arguably invented here. For everyday life with Taiwanese quality systems, it's the sweet spot.",
    delta: 3,
    tags: ["livable", "affordable", "creative"],
    scores: { pressure: 72, viability: 86, capability: 82, community: 84 },
    manifestStatus: "locked",
    cityType: "secondary",
    inclusionRationale: "Taiwan's second-city livability benchmark; proof that national system quality translates even outside the capital.",
    sentimentEmojis: ["🧋", "🏛️", "🌤️", "🛵", "😊"],
    metrics: {
      pppIncomePerHead: 32400,
      graduateHousingShare: 26,
      healthcare: { access: "Universal public access", affordability: "Low cost", summary: "Same Taiwanese NHI system as Taipei with shorter queues and easier clinic access." },
      education: { access: "Broad public access", affordability: "Low cost", summary: "National Chung Hsing University and Tunghai anchor a solid education infrastructure." },
      experienceDiversity: 82,
    },
  },
  bengaluru: {
    ...
    signal: "Bengaluru is India's Silicon Valley for real: Infosys, Wipro, and a startup scene that produces more unicorns than anywhere in Asia outside China. The climate at 900m elevation is India's most pleasant. But traffic has become legendary — a 10 km commute can take 90 minutes. The lake ecology that made the city beautiful is severely degraded. What you earn, you spend in time.",
    delta: 1,
    tags: ["tech", "traffic", "startups"],
    scores: { pressure: 68, viability: 52, capability: 66, community: 64 },
    manifestStatus: "locked",
    cityType: "primary",
    inclusionRationale: "India's tech economy benchmark; reveals how innovation-driven growth can outrun infrastructure and ecology.",
    sentimentEmojis: ["💻", "🚗", "☕", "🌳", "😤"],
    metrics: {
      pppIncomePerHead: 14800,
      graduateHousingShare: 34,
      healthcare: { access: "Mixed public-private", affordability: "Low to moderate cost", summary: "Private hospitals are excellent and affordable by global standards; public system is overcrowded." },
      education: { access: "Broad access", affordability: "Low to moderate cost", summary: "IISc and multiple engineering colleges create a deep tech talent pipeline; primary/secondary quality is highly variable." },
      experienceDiversity: 76,
    },
  },
};
