...
const topCityOverrides: Record<string, CityOverride> = {
  ...
  busan: {
    ...
    scores: { pressure: 64, viability: 82, capability: 78, community: 72 },
    manifestStatus: "locked",
    cityType: "primary",
  ...
  bangkok: {
    ...
    scores: { pressure: 80, viability: 74, capability: 76, community: 88 },
    manifestStatus: "locked",
    cityType: "primary",
  ...
  krakow: {
    ...
    scores: { pressure: 78, viability: 80, capability: 80, community: 82 },
    manifestStatus: "locked",
    cityType: "secondary",
