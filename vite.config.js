        ...
        rollupOptions: {
            output: {
                manualChunks: function (id) {
                    ...
                    if (id.includes("src/rankingsData.ts"))
                        return "rankings-data";
                    if (id.includes("src/methodologyData.ts"))
                        return "methodology-data";
                    if (id.includes("src/compareRankingsData.ts"))
                        return "compare-data";
                    if (id.includes("publishedRankingData.json"))
                        return "published-data";
                    if (id.includes("src/siteCopy.ts"))
                        return "site-copy";
                    if (id.includes("src/ideasData.ts"))
                        return "ideas-data";
                    if (id.includes("src/thailandData") || id.includes("src/thailandDeckData"))
                        return "thailand-data";
